            ...
            <div class="card-body">
                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="number" min="1" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}">
                            @if ($errors->has('price'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="number" min="1" class="form-control @error('qty_in_stock') is-invalid @enderror" id="qty_in_stock" name="qty_in_stock" value="{{ old('qty_in_stock') }}">
